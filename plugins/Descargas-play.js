...
🌟 ¡Encuentra y descarga tu música favorita! 🎶
  ...
  try {
    ...
    // ===== APIs para audio MP3 =====
            const fuentes = [
           { api: 'ZenzzXD', endpoint: `https://api-adonix.ultraplus.click/download/ytvideo?url=${encodeURIComponent(url)}&apikey=WilkerKeydukz9l6871(url)}`, extractor: res => res.download_url },
